 ...
 *
 * @example
 * // Automatic: guessed from the label, live, so a rename changes it.
 * <NodeIcon icon="" label="Postgres" />
 * // Pinned, and 'none' draws nothing at all.
 * <NodeIcon icon="aws:s3" label="Raw bucket" />
 */
